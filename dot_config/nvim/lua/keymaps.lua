...
nmap(L("to"), C("IronRepl"), "Open")
nmap(L("th"), C("IronHide"), "Hide")
nmap(L("tf"), C("IronFocus"), "Hide")
nmap(L("tx"), C("IronExit"), "Exit")
nmap(L("ti"), C("lua require('iron.core').interrupt"), "Interrupt")
nmap(L("tl"), C("lua require('iron.core').send_line"), "Line")
nmap(L("tp"), C("lua require('iron.core').send_paragraph"), "Pragraph")
nmap(L("tc"), C("lua require('iron.core').send_until_cursor"), "Cursor")
nmap(L("tv"), C("lua require('iron.core').visual_send"), "Visual")
vmap(L("tC"), C("lua require('iron.core').clear"), "Clear")
