return {
	{ -- Autocompletion
		...
		dependencies = {
			...
			{ "zbirenbaum/copilot-cmp", opts = { fix_pairs = false, auto_trigger = true } },
			{
				"tzachar/cmp-fuzzy-buffer",
				dependencies = { { "tzachar/fuzzy.nvim" }, { "romgrk/fzy-lua-native", run = "make" } },
			},
		},
		config = function()
			...
			cmp.setup({
				...
				sources = {
					...
					{ name = "fuzzy_buffer", group_index = 2, max_item_count = 3 },
					{ name = "cmp_r", group_index = 2, max_item_count = 3 },
					{ name = "path", group_index = 2, max_item_count = 3 },
					{ name = "cmdline", group_index = 3, max_item_count = 2 },
					{ name = "copilot", group_index = 4, max_item_count = 2 },
				},
				formatting = {
