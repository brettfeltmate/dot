...
settings.theme = `
  ...
  .sk_scroller_indicator_top {
    background-image: linear-gradient(#151016, transparent);
  }
  .sk_scroller_indicator_middle {
    background-image: linear-gradient(transparent, #151016, transparent);
  }
  .sk_scroller_indicator_bottom {
    background-image: linear-gradient(transparent, #151016);
  }
  #sk_bubble * {
  ...
  div.sk_arrow[dir=down]>div:nth-of-type(2) {
    border-top: 10px solid #bdbdc3;
  }
  div.sk_arrow[dir=up]>div:nth-of-type(2) {
    top: 2px;
    border-bottom: 10px solid #bdbdc3;
  }
...
:root {
    ...
    --theme-ace-cursor:#DB8D7C;
    --theme-ace-select:#7A515A;
}
